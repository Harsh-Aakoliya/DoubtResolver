...
//for bookmark given question
export const bookmarkQuestion=(userId,questionId)=>API.patch(`/questions/bookmark`,{userId,questionId});
...
export const updateTags =(id,updateData)=>API.patch(`/tags/update/${id}`,updateData);
